...
- Recovery cleanup: Mystery, Race, and Map failures now show a direct retry command instead of a passive error strip, keeping the game loop recoverable after API/network failures.
